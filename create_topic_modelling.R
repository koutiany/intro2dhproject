...
textdata <- read.csv("lines_all_characters.csv", sep = ",", encoding = "UTF-8")
textdat
...
himym_collocations <- quanteda.textstats::textstat_collocations(corpus_tokens, min_count = 25)
...
top10_terms <- c("ted", "lilly", "marshall", "barney", "robin", "hey", "hello", "hi")
